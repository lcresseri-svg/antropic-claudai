...
export function InsightTicker({ transactions, monthlyIncome, monthlyExpenses, monthlyInvestments, prebuilt, limit = 8, onSeeAll }: Props) {
  ...
  return (
    <section>
      ...
      <div className="flex gap-3 overflow-x-auto scrollbar-hide -mx-4 px-4 scroll-pl-4 snap-x snap-mandatory xl:grid xl:grid-cols-3 xl:overflow-visible xl:mx-0 xl:px-0">
        {insights.map((ins, i) => (
