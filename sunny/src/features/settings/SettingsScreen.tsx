        ...
        <>
          ...
          <div className="space-y-3 md:max-w-2xl">
            ...
            <InfoBlock icon="🔮" title="Previsione di fine mese">
              Le <b>uscite previste</b> usano un modello "quanto hai già speso + quanto spendi di solito nei giorni che restano": <b>spese finora + (frazione di mese rimasta × media mensile storica)</b>. All'inizio del mese conta quasi solo la tua media (più affidabile), col passare dei giorni conta sempre più quello che hai speso davvero, e a fine mese coincide col totale reale. Se non c'è storico, si riproietta semplicemente il ritmo attuale. Le <b>entrate previste</b> sono la cifra più alta tra quanto hai già incassato e quanto incassi di solito (lo stipendio spesso arriva tutto insieme). Il risparmio stimato è <b>entrate previste − uscite previste − investimenti previsti</b>. La stessa formula è usata sia negli Insight sia nei Consigli del Budget, così non si contraddicono.
            </InfoBlock>
