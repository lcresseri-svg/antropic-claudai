...
export const VERSIONS: VersionEntry[] = [
  {
    ...
    changes: [
      ...
      'Nuova card "Investimenti" con il ⓘ che scompone quanto hai investito nel mese: dai tuoi conti, apporti esterni, TFR e il totale.',
      'Su computer le quattro card stanno affiancate, su telefono si dispongono in griglia 2×2.',
      'Il flusso netto resta lo stesso di prima e le card tornano sempre: Entrate − Uscite − Investimenti = Flusso netto.',
    ],
  },
  {
  ...
  },
  {
    ...
    changes: [
      'Nuova schermata "Saldo per conto": scegli un periodo (Mese / 3M / 6M / 12M), naviga avanti e indietro nel tempo e vedi la liquidità totale e il saldo di ogni conto con la variazione del periodo.',
      'Toccando un conto si apre il dettaglio con l\'andamento del saldo nel periodo e i flussi (entrate, uscite, investimenti).',
      'Accessibile dalla card "Saldo per conto" in dashboard (in anteprima).',
    ],
  },
  {
    version: '1.10.7', date: '2026-06-16', title: 'Card del tema chiaro più chiare',
    changes: [
      'Nel tema chiaro le card sono ora un po\' più chiare, con uno stacco più morbido rispetto allo sfondo.',
    ],
  },
  {
  ...
  },
  {
    ...
    changes: [
      'Nel tema chiaro lo sfondo è ora quasi identico alle card, come nel tema scuro: la separazione è affidata ai bordi sottili invece che al forte stacco beige/bianco di prima.',
    ],
  },
  {
